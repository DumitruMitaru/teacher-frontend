...
const useApi = () => {
	...
	return {
		...
		deleteComment: id => makeRequest('delete', `comment/${id}`),
		...
		editComment: (id, comment) => makeRequest('put', `comment/${id}`, comment),
		...
		publicDeleteComment: (publicProfileId, id) => makeRequest('delete', `public/${publicProfileId}/comment/${id}`),
		publicDeleteUpload: (publicProfileId, id) => makeRequest('delete', `public/${publicProfileId}/upload/${id}`),
		publicEditComment: (publicProfileId, id, comment) => makeRequest('put', `public/${publicProfileId}/comment/${id}`, comment),
